...
```{r}
dfm_uncertain1<-dfm_trim(dfm_uncertain, min_termfreq = 0.5, termfreq_type = "quantile",
                         max_docfreq = 0.5, docfreq_type = "prop")
dfm_other1<-dfm_trim(dfm_other, min_termfreq = 0.5, termfreq_type = "quantile",
                     max_docfreq = 0.5, docfreq_type = "prop")
dfm2<-dfm_trim(dfm1, min_termfreq = 0.8, termfreq_type = "quantile",
...
```{r}
terms(topic2, 10) #uncertain
```
And the certain questions:
```{r}
terms(topic3, 10) #other
#terms(topic4, 10)
```
